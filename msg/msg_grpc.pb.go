...
type MsgServer interface {
	...
	// Delete messages for a specified user that were sent before a given timestamp.
	DeleteUserMsgsByTime(context.Context, *DeleteUserMsgsByTimeReq) (*DeleteUserMsgsByTimeResp, error)
	// Set whether the API-sent message was delivered successfully
...
func (UnimplementedMsgServer) DeleteUserMsgsByTime(context.Context, *DeleteUserMsgsByTimeReq) (*DeleteUserMsgsByTimeResp, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteUserMsgsByTime not implemented")
}
...
func _Msg_DeleteUserMsgsByTime_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteUserMsgsByTimeReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).DeleteUserMsgsByTime(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_DeleteUserMsgsByTime_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).DeleteUserMsgsByTime(ctx, req.(*DeleteUserMsgsByTimeReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Msg_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DeleteUserMsgsByTime",
			Handler:    _Msg_DeleteUserMsgsByTime_Handler,
		},
		{
